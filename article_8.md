...
可以得到，精馏段平均密度$\rho_{L,m,精}=843.9\mathrm{kg/m^3}$，提馏段平均密度$\rho_{L,m,提}=924.0\mathrm{kg/m^3}$
...
可得精馏段平均表面张力$\sigma_{m,1}=21.26 \mathrm{mN/m}$，提馏段平均表面张力为$\sigma_{m},2=22.85\mathrm{mN/m}$。
