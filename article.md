...
![x-y图，t-x,y图](resources/x-y,t-x,y.png)

进料q值为1[^q]，因此$\mathrm{y_e}=0.935$,$\mathrm{x_e}=\mathrm{x_F}=0.728$，$\mathrm{x_D}=0.9860$，故最小回流比为：
